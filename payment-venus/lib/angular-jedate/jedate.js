...
;(function(root, factory) {
    ...
    jedfn.setHtml = function(opts){
        ...
        '</div>' + "</div>" :(dateFormat == "YYYY" ? '<ul class="jedayy"></ul>' :　'<ul class="jedaym"></ul>');
        var dateriList = '<ol class="jedaol"></ol><ul class="jedaul"></ul>';
        var bothmsStr = !isYYMM ? '<div class="botflex jedatehmsshde"><ul class="jedatehms"><li><input type="text" /></li><i>:</i><li><input type="text" /></li><i>:</i><li><input type="text" /></li></ul></div>' + '<div class="botflex jedatebtn"><span class="jedateok">确认</span><span class="jedateclear">清空</span></div>' :(dateFormat == "YYYY" ? '<div class="botflex jedatebtn"><span class="jedateok" style="width:20%">确认</span><span class="jedateclear" style="width:20%">清空</span></div>' : '<div class="botflex jedatebtn"><span class="jedateok">确认</span><span class="jedatetodaymonth">本月</span><span class="jedateclear">清空</span></div>');
        ...
        boxCell.find(".jedatebot .jedateok").on("click", function(ev) {
            ...
            if (isValtext) {
                ...
                if (ishhmmss) {
                    ...
                    if(isYYMM){
                        okDate = [ newDate.getFullYear(), newDate.getMonth() + 1, newDate.getDate()];//modified by zhangwei 只显示年份模式点击确认报错bug处理
