...
require([
    ...
    printDemo.controller('PrintCtrl',['$scope','$timeout',function ($scope, $timeout) {
        ...
        $scope.comCode=_printData.testcomCode;
        $scope.handlerCode=_printData.testhandlerCode;
        $scope.balanceDate=_printData.testbalanceDate;
        $scope.currency=_printData.testcurrency;
        $scope.bpaymentList=_printData.testbpaymentList;
