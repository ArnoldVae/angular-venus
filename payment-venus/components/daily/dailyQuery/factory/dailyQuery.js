...
define(['../module','config'], function (moduleApp,config) {
    ...
    function dailyQueryHandler($http,$$adapter,ApiPath) {
        ...
        var preClaimModify=function(keywords,options,pagination){
            var _data=keywords;
        ...
        return {
            ...
            preClaimModify: function (keywords,options,pagination) {
                return preClaimModify(keywords,options,pagination);
            },
